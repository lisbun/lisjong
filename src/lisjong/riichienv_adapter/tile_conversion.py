...
どちらの変換規則も、`docs/riichienv-investigation.md`の実測(400+ seedに
わたる`legal_actions()`のDiscard Action `tile` -> `to_mjai()`比較、および
複数kyokuにわたるdahai/kakan/dora event JSONの直接観測)で確認した
