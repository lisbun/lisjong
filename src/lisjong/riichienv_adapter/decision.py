...
Issue #28のseat-visible materialized state / ``PolicyInput``生成と、Issue #29の
decision-local Action mappingを、同じseat・同じ``Observation``について実行し、
既存の``DecisionContext``と対応mappingを不可分な組として返す。
